...
// Generic 3D Model component with hover animation
const Model3D: React.FC<ModelProps> = ({ position, modelPath, scale = 1 }) => {
...
function calculateCircularPosition(index: number, total: number, radius: number): [number, number, number] {
...
const ThreeScene = () => {
  const totalItems = 4 // Updated for all models
  const radius = 3.5 // Slightly increased for more items
